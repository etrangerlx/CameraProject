...
public class Camera2SurfaceActivity extends AppCompatActivity {
        ...
        try {
            ...
            mCameraDevice.createCaptureSession(Arrays.asList(surface), new CameraCaptureSession.StateCallback() {
                ...
                public void onConfigureFailed(@NonNull CameraCaptureSession session) {
                    Toast.makeText(Camera2SurfaceActivity.this, "Configuration failed", Toast.LENGTH_SHORT).show();
                }
            }, mBackgroundHandler);
        } catch (CameraAccessException e) {
            e.printStackTrace();
                    ...
                    try {
                        session.capture(captureBuilder.build(), new CameraCaptureSession.CaptureCallback() {
                            ...
                            public void onCaptureCompleted(@NonNull CameraCaptureSession session, @NonNull CaptureRequest request, @NonNull TotalCaptureResult result) {
                                ...
                                // 使用 Handler.post 代替 runOnUiThread 避免深层嵌套
                                if (mBackgroundHandler != null) {
                                    mBackgroundHandler.post(() -> {
                                        runOnUiThread(() -> 
                                            Toast.makeText(Camera2SurfaceActivity.this, "Picture saved", Toast.LENGTH_SHORT).show()
                                        );
                                    });
                                }
                                startPreview();
